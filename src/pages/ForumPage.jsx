...
export default function ForumPage() {
  ...
  return (
    <div className="min-h-screen bg-blue-900 relative font-sans pt-28 pb-20">
      {/* Background Pattern */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="mb-10">
          <button
            onClick={() => navigate("/")}
            className="flex items-center text-blue-200 hover:text-white mb-6 transition-colors group"
          >
          ...
          <div className="flex flex-col lg:flex-row justify-between items-end gap-6">
            <div className="w-full lg:w-2/3">
              ...
              <div className="relative w-full shadow-2xl">
                ...
                <input
                  type="text"
                  className="w-full pl-12 pr-4 py-4 rounded-xl text-gray-900 placeholder-gray-500 bg-white focus:outline-none focus:ring-4 focus:ring-blue-500/50"
            ...
            <button className="w-full lg:w-auto bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-xl font-bold shadow-lg flex items-center justify-center gap-2 transition-transform active:scale-95 whitespace-nowrap">
              <Plus size={20} />
              Ask a Free Question
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr_300px] gap-8 items-start">
          ...
          <div className="hidden lg:block sticky top-10 h-fit">
            <div className="bg-white rounded-2xl shadow-xl p-4 border-4 border-white/10">
              <h3 className="font-bold text-gray-900 mb-4 px-2 text-sm uppercase tracking-wider text-opacity-70">
                Browse Topics
              </h3>
          ...
          <div className="flex flex-col gap-6">
                ...
                <button
                  ...
                  className={`flex-shrink-0 px-5 py-2 rounded-full text-sm font-bold border transition-colors ${
                    activeCat === cat.id
                      ...
                      : "bg-blue-800/50 text-blue-100 border-blue-700 hover:bg-blue-800"
                  }`}
                >
                  {cat.label}
                </button>
            ...
            {FORUM_POSTS.map((post) => (
              ...
              >
                {/* Question Header */}
                <div className="mb-4">
                  <span className="text-[10px] uppercase font-bold text-blue-600 bg-blue-50 px-2 py-1 rounded-md tracking-wider">
                    {post.category}
                  </span>
                  <h3 className="text-xl font-bold text-gray-900 mt-3 leading-snug cursor-pointer hover:text-blue-700 transition-colors">
                    {post.question}
                  </h3>
                </div>

                {/* Answer Section */}
                <div className="bg-gray-50 rounded-xl p-5 mb-5 border border-gray-100 relative">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    {post.excerpt}
                    <button className="text-blue-600 font-bold text-xs ml-2 hover:underline">
                      Read Full Answer
                    </button>
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="flex items-center gap-4">
                    <button className="flex items-center gap-1.5 text-gray-500 hover:text-blue-600 text-sm transition-colors font-medium hover:bg-blue-50 px-2 py-1 rounded-lg">
                      <ThumbsUp size={18} />
                      {post.likes}
                    </button>
                    <button className="flex items-center gap-1.5 text-gray-500 hover:text-blue-600 text-sm transition-colors font-medium hover:bg-blue-50 px-2 py-1 rounded-lg">
          ...
          >
            ...
            {/* Top Doctors Promo */}
            <div className="bg-gradient-to-br from-blue-800 to-blue-900 rounded-2xl shadow-lg p-6 text-white border border-blue-700">
              ...
              <div className="space-y-3">
                {[1, 2].map((i) => (
                  <div
                    key={i}
                    className="flex items-center gap-3 bg-white/10 p-3 rounded-xl backdrop-blur-sm hover:bg-white/20 transition-colors cursor-pointer border border-white/5"
                  >
              ...
              <button className="w-full mt-5 py-3 bg-white text-blue-900 text-xs font-bold rounded-xl hover:bg-blue-50 transition-colors shadow-sm flex items-center justify-center gap-1">
