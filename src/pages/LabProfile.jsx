  ...
  return (
    ...
    <div className="min-h-screen bg-blue-900 relative font-sans pt-28 pb-20">
      ...
      <div className="max-w-3xl mx-auto px-4 relative z-10">
        ...
        {/* 3. LAB HEADER CARD */}
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-4 border-white/10 mb-6">
          <div className="p-6 flex items-start justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 mb-1">
                {lab.name}
              </h1>
              <p className="text-gray-500 text-sm mb-3">{lab.location}</p>
          ...
          <div className="px-6 pb-6 bg-gray-50 pt-4 border-t border-gray-100">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between text-blue-100 px-1">
          ...
          {filteredTests.map((test, idx) => (
            <div
              key={idx}
              className="bg-white p-4 rounded-xl shadow-lg border-l-4 border-orange-500 flex justify-between items-center hover:scale-[1.01] transition-transform"
            >
              <div>
                <h3 className="font-bold text-gray-800 text-lg">{test.name}</h3>
                <span className="text-[10px] uppercase font-bold text-gray-500 bg-gray-100 px-2 py-1 rounded mt-1 inline-block">
                  {test.category}
                </span>
              </div>
              <div className="text-right">
                ...
                <button className="text-xs font-bold text-white bg-blue-900 px-4 py-2 rounded-lg shadow hover:bg-blue-800 flex items-center ml-auto">
          ...
          {filteredTests.length === 0 && (
            <div className="text-center py-10 bg-white/5 rounded-xl border border-white/10 text-blue-200">
